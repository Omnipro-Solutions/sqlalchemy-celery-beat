...
class test_SessionManager:
    ...
    def test_create_session_forked(self, sessionmaker):
        ...
        sessionmaker.assert_called_with(
            bind=s.get_engine().execution_options(schema_translate_map={"public": None}), expire_on_commit=False
        )
    ...
    def test_prepare_models_terminates(self, create_engine):
        ...
        patch_create_all = patch.object(ModelBase.metadata, "create_all", side_effect=raise_err)
